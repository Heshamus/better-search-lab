...
export const SETTINGS: readonly SettingDef[] = [
  ...
  def({ group: "llm", field: "model", label: "Model", description: "Model id; the preset suggests one, the dropdown lists what the provider reports.", secret: false, env: "LLM_MODEL", schema: text, placeholder: "deepseek-chat" }),
