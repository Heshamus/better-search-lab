...
export function CompetitorsStep({ projectId, competitors }: { projectId: string; competitors: Competitor[] }) {
  ...
  return (
    <div className="flex flex-col gap-4">
      <div>
        <h1 className="text-base font-semibold text-neutral-900">Competitors</h1>
        <p className="mt-1 text-sm text-neutral-600">Up to five domains you compete with in search. Suggest finds the ones that already overlap with your rankings.</p>
      </div>
