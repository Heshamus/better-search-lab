  ...
  return (
    <div className="panel flex flex-col gap-3 p-4">
      <div className="flex flex-col gap-1">
        ...
        <code className="select-all break-all font-mono text-sm text-neutral-800">{DEMO_MCP_TOKEN}</code>
      </div>
      <p className="text-xs text-neutral-500">
        Read-only; the demo data is synthetic. Run the MCP server with <code className="font-mono text-neutral-700">{`npx -y ${MCP_PACKAGE_URL}`}</code> and BSL_URL set to this demo.
      </p>
    </div>
  );
}
