...
No clone and no npm account needed: every release attaches the built package, and `npx` runs it from that URL.
    ...
    npx -y https://gitlab.com/betterbrainlab/better-search-lab/-/releases/v1.1.2/downloads/better-search-lab-mcp.tgz
...
```json
{
  "mcpServers": {
    "better-search-lab": {
      "command": "npx",
      "args": ["-y", "https://gitlab.com/betterbrainlab/better-search-lab/-/releases/v1.1.2/downloads/better-search-lab-mcp.tgz"],
      "env": {
